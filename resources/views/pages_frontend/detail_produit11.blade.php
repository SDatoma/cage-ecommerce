...
<head>
	...
	<meta name="keywords" content="Grocery Shoppy Responsive web template, 
			...
			<div class="col-md-5 single-right-left ">
				<div class="grid images_3_of_2">
					<div class="flexslider">
						<ul class="slides">
							<li data-thumb="{{asset('css_frontend/images/si.jpg')}}">
								<div class="thumb-image">
									<img src="{{asset('css_frontend/images/si.jpg')}}" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="{{asset('css_frontend/images/si2.jpg')}}">
								<div class="thumb-image">
									<img src="{{asset('css_frontend/images/si2.jpg')}}" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
							<li data-thumb="{{asset('css_frontend/images/si3.jpg')}}">
								<div class="thumb-image">
									<img src="{{asset('css_frontend/images/si3.jpg')}}" data-imagezoom="true" class="img-responsive" alt=""> </div>
							</li>
						</ul>
